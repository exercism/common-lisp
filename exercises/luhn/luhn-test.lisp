...
(define-test more-than-a-single-zero-valid-p
  (assert-true (luhn:valid-p "0000 0")))

(define-test input-digit-9-is-correctly-converted-to-output-digit-9
  (assert-true (luhn:valid-p "091")))

(define-test strings-with-non-digits-is-invalid
  (assert-false (luhn:valid-p ":9")))
