#|
For each side a, so long as a <= n / 3.414, the math works like this:
...
a^2 - c^2 = n^2 - 2an + a^2 - 2nc + c^2 + 2ac

n^2 - 2an + a^2 + a^2 - 2nc + 2ac = 0
...
Given that c is a whole number, and we know a and n, we can calculate b:
