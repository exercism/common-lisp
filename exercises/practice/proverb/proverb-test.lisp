...
(test zero-pieces
    (let ((strings '()))
      (is (equal '() (proverb:recite strings)))))

(test one-piece
    (let ((strings '("nail"))
          (result '("And all for the want of a nail.")))
      (is (equal result (proverb:recite strings)))))

(test two-pieces
    (let ((strings '("nail" "shoe"))
          (result '("For want of a nail the shoe was lost."
...
(test four-pieces-modernized
    (let ((strings '("pin" "gun" "soldier" "battle"))
          (result '("For want of a pin the gun was lost."
